...
/**
 * Classe che incapsula il comando di inserimento di un'agenzia.
 * */
public class InserireAgenzia implements Command {
     ...
     *           Richiesta.
     * */
    public InserireAgenzia(final RequestInt request) {
    ...
    public final ResponseInt execute() {
        ...
        Boolean result = ga.inserireAgenzia(to);

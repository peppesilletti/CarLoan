...
/**
 * Classe che incapsula il comando di inserimento di un'extra.
 * */
public class InserireExtra implements Command {
     ...
     *           Richiesta.
     * */
    public InserireExtra(final RequestInt request) {
    ...
    public final ResponseInt execute() {
        ...
        Boolean result = gm.inserireExtra(to);

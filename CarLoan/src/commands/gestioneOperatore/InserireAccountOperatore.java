...
/**
 * Classe che incapsula il comando di inserimento di un account operatore.
 * */
public class InserireAccountOperatore implements Command {
     ...
     *           Richiesta.
     * */
    public InserireAccountOperatore(final RequestInt request) {
    ...
    public final ResponseInt execute() {
        ...
        Boolean result = go.inserireAccountOperatore(to);
